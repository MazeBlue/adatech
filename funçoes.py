...
saudação("Pam", "Cientista de Dados")
saudação("Jana", " Engenheira de Automação")
saudação("Helena", "Design de moda")
...
saudação("Pam", "Python") # o codigo aceita outro valor definido
